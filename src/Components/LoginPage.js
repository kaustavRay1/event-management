...
const LoginPage = () => {
  return (
    ...
    <Box paddingTop={4} paddingLeft={3}><h2 >Login</h2></Box>
    ...
    <Stack direction={"column"} justifyContent={"center"}>
        ...
        <Stack direction={"column"}>
            <Box className="" justifyContent={"center"} alignItems={"center"} display={"flex"} paddingTop={5}>
              ...
              <Typography paddingLeft={"50%"} paddingTop={0.5}>Forgot password?</Typography>
              <Box paddingTop={2}><input type="submit" value={"Login"} className="login-btn"/></Box>
              <Typography justifyContent="center" alignItems="center"  display="flex" paddingTop={0.5} variant='body2'>Don’t have an account? Signup now</Typography>
              </form>
