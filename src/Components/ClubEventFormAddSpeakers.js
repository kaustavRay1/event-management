        ...
        <form className="event-form-block">
            <Box  p={2} paddingTop={2}>
                <Box  gap={4} width={"100%"} display={"flex"} className="form-flex-dir" alignItems={"center"}>
                 <Box><Card sx={{height:"7.5em", width:"7.5em", backgroundColor:"white", borderRadius:"100%"}}>
                    <img src="" alt='' class="circle-cards"/>
                      </Card>
                      </Box>
                      <Box>
                      < input type="button" value={"Add Profile"} style={{ backgroundColor: "#1C1B1F", height: "2em", width: "6em", justifyContent: "center", alignItems:"center", display: "flex", borderRadius: "10px", color:"#ffff" }}/>
                    </Box>
                      </Box>
                      <Box paddingTop={5}>
                       <Typography >Speaker Name</Typography>
                        <input type='text' required style={{ minWidth:"20vw", borderRadius:"6px", height:"2em",}}/>
                       </Box>
                       <Box  gap={4} width={"100%"} display={"flex"} className="form-flex-dir" paddingTop={2}>
                        <Box>
                       ...
                       <Typography >Email Address</Typography>
                        <input type='email' required style={{ minWidth:"20vw", borderRadius:"6px", height:"2em",}}/>
                        </Box>
                        <Box paddingTop={4} width={"100%"} display={"flex"} className="form-flex-dir" alignItems={"center"} justifyContent={"space-between"}>
                       <input type="button" value={"Add Speaker"} style={{ backgroundColor: "#1C1B1F", height: "2em", width: "8em", justifyContent: "center", alignItems:"center", display: "flex", borderRadius: "10px", color:"#ffff" }}/> 
                            <Input type="reset" value=" Clear "/>
                            </Box>
                           <Box paddingTop={2}> <Divider orientation='horizontal' style={{ backgroundColor: "black", height: "2px" }} /></Box>
                           <Box display={"flex"} paddingTop={2}>
                           <Stack sx={{ justifyContent: "center", alignItems: "center",}}>
                            <Card sx={{ height: "6.37em", width: "6.37em", borderRadius: "100%",}}>
                            <img src="" alt='' class="circle-cards"/>                                      
                             </Card>
            ...
            <Box paddingTop={2} gap={2} p={2} sx={{display:"flex", justifyContent:"flex-end"}}>
                            ...
                            <Box>
                                <Link to={"/clubeventformadditionaldetails"} style={{ textDecoration: 'none' }}><Card sx={{ backgroundColor: "#1C1B1F", height: "2em", width: "6em", justifyContent: "center", alignItems:"center", display: "flex", borderRadius: "10px", color:"#ffff" }}>
